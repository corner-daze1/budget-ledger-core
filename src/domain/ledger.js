import {
  actualBudgetCents as calculateActualBudget,
  budgetDebtCents as calculateBudgetDebt,
  daysInMonth,
  formatDate,
  parseDate,
} from './budget.js';
...
export function recordIncome(state, details) {
...
export function recordExpense(state, details) {
...
export function recordFixedExpense(state, details) {
...
export function recordTransfer(state, details) {
...
export function recordCreditCardRepayment(state, details) {
...
export function recordBorrowing(state, details) {
...
export function recordLoanPrincipalRepayment(state, details) {
  const { id, date, cashAccountId, loanAccountId, amountCents, source = null } = details;
  positiveCents(amountCents);
  requireAsset(state, cashAccountId);
...
export function recordLoanInterestPayment(state, details) {
...
export function recordLoanRepayment(state, details) {
  const {
...
export function recordLoanInterestAccrual(state, details) {
...
export function recordInvestmentTrade(state, details) {
...
export function setInvestmentValue(state, details) {
...
export function getLatestTransaction(state, logicalTransactionId) {
...
export function modifyTransaction(state, {
  logicalTransactionId,
  changes,
  requestId,
  today,
...
export function revokeTransaction(state, {
  logicalTransactionId,
  requestId,
  date,
  today,
...
export function recordRefund(state, details) {
  const {
    id = nextTransactionId(state),
    date,
...
export function revokeRefund(state, {
  logicalTransactionId,
  requestId,
  date,
  today,
...
export function getTransactionActionAvailability(state, logicalTransactionId) {
...
export function listUserTransactions(state, { includeRevoked = false } = {}) {
...
export function createFixedPlan(state, details) {
  const {
    id,
    name,
    amountCents = null,
...
export function editFixedPlan(state, planId, changes) {
...
export function fixedPlanOccurrenceKey(planId, dueDate) {
...
export function nextFixedPlanDueDate(plan, dueDate) {
...
export function advanceFixedPlan(state, planId, handledDueDate) {
...
export function markLegacyPlanPending(state, planId) {
  const plan = state.plans.find((item) => item.id === planId);
  if (!plan) throw new Error(`unknown plan: ${planId}`);
...
export function retryFixedPlanPending(state, {
  pendingId,
  amountCents,
  principalCents,
  interestCents,
...
export function closeBudgetPeriod(state, periodId, settlement = null) {
  const next = clone(state);
  const target = period(next, periodId);
